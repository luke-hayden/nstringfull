...
The last of these has had by far the most importance in dealing with overfitting. Using most (47) of the 61 markers from the 2nd codeset, we get the following model.
...
```{r, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
save(currbest,file="modelrf.rdata")
...
save(vrimprf, file="vrimprf.rdata")

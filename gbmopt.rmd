...
pdf("gbmbigparams.pdf",height=10, width=14)
...
ggsave(plot=p,height=8,width=12,dpi=200, filename=paste("gbmbigparams.pdf"), useDingbats=FALSE, limitsize = FALSE)
...
ggsave(plot=p,height=8,width=12,dpi=200, filename=paste("gbmbig1.pdf"), useDingbats=FALSE, limitsize = FALSE)
```

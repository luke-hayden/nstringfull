...
pdf("gbm1params.pdf",height=10, width=14)
...
pdf("gbm2params.pdf",height=10, width=14)

plot(gbmagemodel2)

dev.off()

pdf("gbm3params.pdf",height=10, width=14)

plot(gbmagemodel3)

dev.off()

pdf("gbm4params.pdf",height=10, width=14)

plot(gbmagemodel4)

dev.off()

pdf("gbm5params.pdf",height=10, width=14)
...
pdf("gbm6params.pdf",height=10, width=14)

plot(gbmagemodel6)

dev.off()

pdf("gbmoldparams.pdf",height=10, width=14)
